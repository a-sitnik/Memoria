...
package memoria.snid1.memoria.libSwipeListView;
...
import memoria.snid1.memoria.libNineOldAndroids.animation.Animator;
import memoria.snid1.memoria.libNineOldAndroids.animation.AnimatorListenerAdapter;
import memoria.snid1.memoria.libNineOldAndroids.animation.ValueAnimator;
import memoria.snid1.memoria.libNineOldAndroids.view.ViewHelper;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

import static memoria.snid1.memoria.libNineOldAndroids.view.ViewHelper.setAlpha;
import static memoria.snid1.memoria.libNineOldAndroids.view.ViewHelper.setTranslationX;
import static memoria.snid1.memoria.libNineOldAndroids.view.ViewPropertyAnimator.animate;
